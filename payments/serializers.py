...
class PaymentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    registration_id = serializers.PrimaryKeyRelatedField(
        queryset=Registration.objects.all(), write_only=True, source="registration"
    )

    class Meta:
        model = Payment
        fields = ["id", "registration", "registration_id", "payment_method", "payment_status", "amount_paid", "_links"]
